...
public class CropImageView extends FrameLayout {
  ...
  public void setOriginRatio() {
    if (mBitmap != null) {
      mCropOverlayView.setAspectRatioX(mBitmap.getWidth());
      mCropOverlayView.setAspectRatioY(mBitmap.getHeight());
    } else {
